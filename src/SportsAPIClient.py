...
# API_Football_key is required if you want to use it. Default Sports_DB_Key is 3.
# (I should probably be able to input keys but for now its fine for MVP)
...
class SportsAPIClient:
    # we will only have 1 session defined per server that is passed through the class rather
